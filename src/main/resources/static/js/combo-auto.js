 ...
 */
/* 출처 : https://codepen.io/pen*/

'use strict';

class ComboboxAutocomplete {
    constructor(comboboxNode, buttonNode, listboxNode, hiddenIdNode) {
        this.comboboxNode = comboboxNode;
        this.buttonNode = buttonNode;
        this.listboxNode = listboxNode;
        this.hiddenIdNode = hiddenIdNode; // added by mslim 2025.01.08
        ...
        switch (event.key) {
            case 'Enter':
                if (this.listboxHasVisualFocus) {
                    ...
                    this.setValue(this.option.textContent, this.option.id); // added id by mslim 2025.01.08
                }
                this.close(true);
            ...
            case 'Escape':
                if (this.isOpen()) {
                    ...
                    this.setValue('','');// added id by mslim 2025.01.08
